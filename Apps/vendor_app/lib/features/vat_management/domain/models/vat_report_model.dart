...
class OrderTransactions {
  ...
  OrderTransactions.fromJson(Map<String, dynamic> json) {
    ...
    sellerAmount = double.tryParse(json['seller_amount'].toString()).toString();
...
class Seller {
  ...
  Seller.fromJson(Map<String, dynamic> json) {
    ...
    minimumOrderAmount = json['minimum_order_amount'] != null ? double.tryParse(json['minimum_order_amount'].toString()) : null;
    freeDeliveryStatus = json['free_delivery_status'];
    freeDeliveryOverAmount = json['free_delivery_over_amount'] != null ? double.tryParse(json['free_delivery_over_amount'].toString()) : null;
