                                              ...
                                              SizedBox(
                                                ...
                                                child: CustomTextFieldWidget(
                                                  ...
                                                  onChanged: (value) {
                                                    ...
                                                    print('------>>${double.parse(PriceConverter.convertPriceWithoutSymbol(context, total))}');
                                                    print('------>>${amount}');
                                                    print('------>>${cartController.isPaidAmountLess}');

                                                    print(amount! < double.parse(PriceConverter.convertPriceWithoutSymbol(context, total)));

                                                    if(amount != null && (amount >= total)) {
                                                      cartController.setPaidAmountles(false);
                                                    }

                                                    if (amount != null && (amount < double.parse(PriceConverter.convertPriceWithoutSymbol(context, total))) && !cartController.isPaidAmountLess) {
                                                      print("paid amount less");
