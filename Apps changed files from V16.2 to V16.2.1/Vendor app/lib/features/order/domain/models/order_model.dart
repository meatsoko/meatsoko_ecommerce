...
class Order {
  ...
  Order.fromJson(Map<String, dynamic> json) {
    ...
    print("---init order amount--- ${json['init_order_amount']}");
    if(json['init_order_amount'] != null){
      try{
        _initOrderAmount = json['init_order_amount'].toDouble();
      }catch(e){
        _initOrderAmount = double.parse(json['init_order_amount'].toString());
      }
    }
