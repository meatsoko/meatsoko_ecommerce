...
import 'package:vendor_app/features/pos/widgets/invoice_element_widget.dart';
                      ...
                      return cartController.invoice != null && cartController.invoice!.details != null &&  cartController.invoice!.details!.isNotEmpty ?
                        ...
                        child: Column(children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                            ...
                            Text(
                              PriceConverter.getUnitCurrency(context, changeAmount < 1  && changeAmount > -1  ? 0 : changeAmount),
                              style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)
                            ),
                          ]),
