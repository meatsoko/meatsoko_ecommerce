...
import 'package:vendor_app/features/addProduct/screens/add_product_screen.dart';
...
import 'package:vendor_app/features/order_details/domain/models/order_details_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return  Consumer<OrderDetailsController>(
       builder: (context, orderDetailsController, child) {
         print("-------->>Orderdetails----->>>${orderDetailsController?.orderDetails?[0]?.order?.initOrderAmount}");
         print("-------->>Orderdetails----->>>${orderDetailsController?.orderDetails?[0]?.order?.orderAmount}");
                ...
                children: [
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(PriceConverter.convertPrice(context,  orderDetailsController.orderDetails![0].order!.initOrderAmount),
                          style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)
                        ),
