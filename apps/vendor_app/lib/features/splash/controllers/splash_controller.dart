...
import 'package:vendor_app/features/splash/domain/services/splash_service_interface.dart';
...
class SplashController extends ChangeNotifier {
  ...
  void getCurrencyData(String? currencyCode) {
    print("--GetCurrencyDataCall-->>$currencyCode--->>");
    for (var currency in _configModel!.currencyList!) {
      if(currencyCode == currency.code) {
        print("--GetCurrencyDataCall-->>${currency.exchangeRate}--->>}");
        _myCurrency = currency;
        _currencyIndex = _configModel!.currencyList!.indexOf(currency);

        print("--GetCurrencyDataCall-->>${myCurrency?.code}--->>}");
        print("--GetCurrencyDataCall-->>${myCurrency?.exchangeRate}--->>}");
        continue;
      }
    }
  }
