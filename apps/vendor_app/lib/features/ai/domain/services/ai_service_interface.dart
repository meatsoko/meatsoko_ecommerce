...
abstract class AiServiceInterface {
  ...
  Future<dynamic> generateAuctionTitle({required String title, required String langCode});

  Future<dynamic> generateAuctionDescription({required String title, required String langCode});
