@php
    $v2SetupData = function_exists('checkSetupGuideRequirements') ? checkSetupGuideRequirements(panel: 'admin') : ['steps' => [], 'completePercent' => 100, 'totalSteps' => 0];
    $v2SetupDone = ($v2SetupData['completePercent'] ?? 100) >= 100;
    $v2SetupShow = !$v2SetupDone && auth('admin')->user()->admin_role_id == 1;
    ...
    // Ring circumference = 2πr for r=20 ≈ 125.66
    $v2Circumference = 125.66;
    $v2RingLen = round($v2Circumference * ($v2Percent / 100), 2);
@endphp
