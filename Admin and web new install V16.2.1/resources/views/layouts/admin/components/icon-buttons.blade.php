<div class="card mb-3">
    <div class="card-body">
        <h2 class="text-primary text-uppercase mb-3">Icon Button</h2>
...
<pre><code><button class="btn btn-outline-success icon-btn">
    <i class="fi fi-sr-check"></i>
</button></code></pre>
                                    </div>
                                </div>
                        ...
                        <div class="position-relative snippets-code-hover">
                            ...
                            <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                ...
                                <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                    tabindex="0">
                                    <div class="component-snippets-code-container">
<pre><code><button class="btn btn-outline-danger icon-btn">
    <i class="fi fi-rr-cross-small"></i>
</button></code></pre>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="component-snippets-container">
                        <div class="component-snippets-preview">
                            ...
                            <button class="btn btn-outline-success btn-outline-success-dark icon-btn">
                        ...
                        <div class="position-relative snippets-code-hover">
                            ...
                            <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                ...
                                <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                    tabindex="0">
                                    <div class="component-snippets-code-container">
<pre><code><button class="btn btn-outline-success btn-outline-success-dark icon-btn">
    <i class="fi fi-sr-down-to-line"></i>
</button></code></pre>
                                    </div>
                                </div>
                        ...
                        <div class="position-relative snippets-code-hover">
                            ...
                            <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                ...
                                <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                    tabindex="0">
                                    <div class="component-snippets-code-container">
<pre><code><button class="btn btn-outline-secondary icon-btn">
    <i class="fi fi-rr-time-quarter-past"></i>
</button></code></pre>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="component-snippets-container">
                        <div class="component-snippets-preview">
                            ...
                            <button class="btn btn-outline-info btn-outline-info-dark icon-btn">
                        ...
                        <div class="position-relative snippets-code-hover">
                            ...
                            <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                ...
                                <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                    tabindex="0">
                                    <div class="component-snippets-code-container">
<pre><code><button class="btn btn-outline-info btn-outline-info-dark icon-btn">
    <i class="fi fi-sr-eye"></i>
</button></code></pre>
                                    </div>
                                </div>
                        ...
                        <div class="position-relative snippets-code-hover">
                            ...
                            <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                ...
                                <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                    tabindex="0">
                                    <div class="component-snippets-code-container">
<pre><code><button class="btn btn-outline-info icon-btn">
    <i class="fi fi-sr-pencil"></i>
</button></code></pre>
                                    </div>
                                </div>
                        ...
                        <div class="position-relative snippets-code-hover">
                            ...
                            <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                ...
                                <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                    tabindex="0">
                                    <div class="component-snippets-code-container">
<pre><code><button class="btn btn-outline-warning btn-outline-warning-dark icon-btn">
    <i class="fi fi-sr-settings"></i>
</button></code></pre>
                                    </div>
                                </div>
                        ...
                        <div class="position-relative snippets-code-hover">
                            ...
                            <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                ...
                                <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                    tabindex="0">
                                    <div class="component-snippets-code-container">
<pre><code><button class="btn btn-outline-primary btn-outline-primary-dark icon-btn">
    <i class="fi fi-sr-menu-dots-vertical"></i>
 </button></code></pre>
                                    </div>
                                </div>
                        ...
                        <div class="position-relative snippets-code-hover">
                            ...
                            <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                ...
                                <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                    tabindex="0">
                                    <div class="component-snippets-code-container">
<pre><code><button class="btn btn-outline-danger bg-danger bg-opacity-10 icon-btn">
    <i class="fi fi-sr-trash"></i>
</button></code></pre>
                                    </div>
                                </div>
