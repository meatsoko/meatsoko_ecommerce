    ...
    <div class="card-body">
        ...
        <div class="d-flex flex-column gap-4">
            <div class="border border-dashed border-info rounded p-3 d-flex flex-column gap-4">
                <h3 class="text-primary">Info notes</h3>
                <div class="row g-4">
                    <div class="col-lg-6">
...
<pre><code><div class="bg-info bg-opacity-10 fs-12 px-12 py-10 text-dark rounded d-flex gap-2 align-items-center">
    <i class="fi fi-sr-lightbulb-on text-info"></i>
    <span>For the address setup you can simply drag the map to pick for the perfect
        <span class="fw-semibold">Lat(Latitude) &amp;
            Log(Longitude)
                            ...
                            <div class="component-snippets-preview">
                                ...
                                <div class="bg-info bg-opacity-10 fs-12 px-12 py-10 text-dark rounded">
                                    <div class="d-flex gap-2 align-items-center mb-2">
                                        <i class="fi fi-sr-lightbulb-on text-info"></i>
                                        <span>
                                            In this page the read only fields data are the database &amp; installation related. They are set when you
                                            1st install your system.
                                        </span>
                                    </div>
                            ...
                            <div class="position-relative snippets-code-hover">
                                ...
                                <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                    ...
                                    <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                        tabindex="0">
                                        <div class="component-snippets-code-container">
<pre><code><div class="bg-info bg-opacity-10 fs-12 px-12 py-10 text-dark rounded">
    <div class="d-flex gap-2 align-items-center mb-2">
        <i class="fi fi-sr-lightbulb-on text-info"></i>
        <span>
            In this page the read only fields data are the database &amp; installation related. They are set when you
    ...
    <ul class="m-0 ps-20 d-flex flex-column gap-1 text-body">
        ...
        <li>When you on debug mode to check your system issues &amp; error then you can Live or Dev mode.</li>
            ...
            <div class="border border-dashed border-warning rounded p-3 d-flex flex-column gap-4">
                <h3 class="text-primary">Warning notes</h3>
                <div class="row g-4">
                    <div class="col-lg-6">
                            ...
                            <div class="position-relative snippets-code-hover">
                                ...
                                <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                    ...
                                    <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                        tabindex="0">
                                        <div class="component-snippets-code-container">
<pre><code><div class="bg-warning bg-opacity-10 fs-12 px-12 py-10 text-dark rounded d-flex gap-2 align-items-center">
    <i class="fi fi-sr-info text-warning"></i>
    <span>
        Be careful when change anything in this page. They are directly connected to your system database.
    </span>
                            ...
                            <div class="component-snippets-preview">
                                ...
                                <div class="bg-warning bg-opacity-10 fs-12 px-12 py-10 text-dark rounded">
                                    <div class="d-flex gap-2 align-items-center mb-2">
                                        <i class="fi fi-sr-info text-warning"></i>
                                        <span>
                                            In this page you can setup latest version app forcefully activate for the users. Please input proper data
                                            for the app link &amp; versions.
                                        </span>
                                    </div>
                                    <ul class="m-0 ps-20 d-flex flex-column gap-1 text-body">
                            ...
                            <div class="position-relative snippets-code-hover">
                                ...
                                <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                    ...
                                    <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                        tabindex="0">
                                        <div class="component-snippets-code-container">
<pre><code><div class="bg-warning bg-opacity-10 fs-12 px-12 py-10 text-dark rounded">
    <div class="d-flex gap-2 align-items-center mb-2">
        <i class="fi fi-sr-info text-warning"></i>
        <span>
            In this page you can setup latest version app forcefully activate for the users. Please input proper data
    ...
    <ul class="m-0 ps-20 d-flex flex-column gap-1 text-body">
        ...
        <li>This section may help user to get the update features in their app.</li>
            ...
            <div class="border border-dashed border-danger rounded p-3 d-flex flex-column gap-4">
                <h3 class="text-primary">Danger notes</h3>
                <div class="row g-4">
                    <div class="col-lg-6">
                        ...
                        <div class="component-snippets-container">
                            <div class="component-snippets-preview">
                                ...
                                <div class="bg-danger bg-opacity-10 fs-12 px-12 py-10 text-dark rounded d-flex gap-2 align-items-center">
                                    ...
                                    <span>
                                        Currently no payment gateway supported for <span class="fw-semibold">Euro</span> Currency. Select at least one
                                        gateway that support euro to digital payment work properly.
                                    </span>
                                </div>
                            </div>
                            <div class="position-relative snippets-code-hover">
                                ...
                                <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                    ...
                                    <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                        tabindex="0">
                                        <div class="component-snippets-code-container">
<pre><code><div class="bg-danger bg-opacity-10 fs-12 px-12 py-10 text-dark rounded d-flex gap-2 align-items-center">
    <i class="fi fi-sr-triangle-warning text-danger"></i>
    <span>
        Currently no payment gateway supported for <span class="fw-semibold">Euro</span> Currency. Select at least one
        gateway that support euro to digital payment work properly.
                            ...
                            <div class="position-relative snippets-code-hover">
                                ...
                                <div class="tab-content content position-absolute start-0 top-100 shadow-lg bg-white p-1 z-3 mw-100"
                                    ...
                                    <div class="tab-pane fade show active" id="html-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                                        tabindex="0">
                                        <div class="component-snippets-code-container">
<pre><code><div class="bg-danger bg-opacity-10 fs-12 px-12 py-10 text-dark rounded-8">
    <div class="d-flex gap-2 align-items-center mb-2">
        <i class="fi fi-sr-info text-danger"></i>
        <div>
            <h4 class="fw-medium mb-1">V3 Version is available now. Must setup for ReCAPTCHA V3</h4>
