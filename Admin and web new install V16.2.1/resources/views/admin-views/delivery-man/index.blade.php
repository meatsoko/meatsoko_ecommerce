                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="f_name" value="{{old('f_name') }}" class="form-control"  data-required-msg="{{ translate('first_Name_field_is_required') }}" placeholder="{{ translate('first_Name') }}" required data-maxlength="50">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('l_name') }}"  type="text" name="l_name" class="form-control"  data-required-msg="{{ translate('last_name_field_is_required') }}" placeholder="{{ translate('last_Name') }}" required data-maxlength="50">
                                        <div class="d-flex justify-content-end">
                                            <span class="text-body-light">0/50</span>
                                        </div>
                                    </div>
