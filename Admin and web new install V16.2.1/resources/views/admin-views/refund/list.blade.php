                        ...
                        <div class="d-flex gap-3 flex-sm-nowrap align-items-center flex-wrap justify-content-md-end">
                            ...
                            <div class="dropdown d-flex gap-2 align-items-center">
                                <div class="position-relative">
                                    @if(!empty(request('sort_by')) || !empty(request('from_date')) || !empty(request('to_date')) || !empty(request('type')) || !empty(request('status')))
                                    ...
                                    @endif
                                    <button type="button"
                                            class="btn {{ (!empty(request('sort_by')) || !empty(request('from_date')) || !empty(request('to_date')) || !empty(request('type')) || !empty(request('status'))) ? 'btn-primary' : 'btn-outline-primary' }}"
