...
@section('content')
    <div class="content container-fluid">
                        ...
                        <div class="border rounded-3 p-4 bg-white h-100">
                            <div class="p-xl-1">
                                ...
                                <div>
                                    ...
                                    <ul class="d-flex flex-column gap-10 ps-3 list-group">
                                        <li class="text-dark fs-12">
                                            <b>name</b> — {{ translate('required_category_name_text') }}
                                        </li>
                                        @if($position >= 1)
                                            <li class="text-dark fs-12">
                                                <b>category_name</b> — {{ translate('required_the_exact_name_of_the_parent_category_shown_in_the_category_list') }}
                                            </li>
                                        @endif
                                        @if($position == 2)
                                            <li class="text-dark fs-12">
                                                <b>sub_category_name</b> — {{ translate('required_the_exact_name_of_the_parent_sub_category_shown_in_the_sub_category_list') }}
                                            </li>
                                        @endif
                                        <li class="text-dark fs-12">
                                            {{ translate('names_are_matched_automatically_and_are_not_case_sensitive') }}
                                        </li>
                                        <li class="text-dark fs-12">
                                            <b>priority</b> — {{ translate('required_a_whole_number_used_for_sort_order') }}
                                        </li>
                                        <li class="text-dark fs-12">
        ...
        <form class="category-import-form form-advance-validation form-advance-inputs-validation form-advance-file-validation non-ajax-form-validate" action="{{ $formAction }}" method="POST"
