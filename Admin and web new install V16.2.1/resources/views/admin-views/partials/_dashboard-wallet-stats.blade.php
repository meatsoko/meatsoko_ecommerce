            ...
            <div class="card border card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0 fs-14 text-dark">{{translate('commission_earned')}}</div>
                    </div>
                    <div>
            ...
            <div class="card border card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0 fs-14 text-dark">{{translate('delivery_charge_earned')}}</div>
                    </div>
                    <div>
            ...
            <div class="card border card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0 fs-14 text-dark">{{translate('total_tax_collected')}}</div>
                    </div>
                    <div>
            ...
            <div class="card border card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0 fs-14 text-dark">{{translate('pending_amount')}}</div>
                    </div>
                    <div>
