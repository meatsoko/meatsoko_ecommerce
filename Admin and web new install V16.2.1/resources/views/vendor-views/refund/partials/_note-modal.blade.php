        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-20 py-0 mb-30">
                <div class="d-flex flex-column align-items-center text-center mb-30">
                    <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/sticky-note.png') }}" width="60" class="mb-20" alt="">
                    <h2 class="modal-title fs-18 mb-3">{{ translate('Approved_/_rejected_note') }}</h2>
                    <div class="text-center">
                        {!! $status->message !!}
                    </div>
                </div>
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn--primary w-120" data-dismiss="modal">{{ translate('Okay') }}</button>
                </div>
            </div>
        </div>
    </div>
