<div class="bid-product-details-body">
            ...
            <div class="col-sm-8">
                <div>
                    ...
                    <div class="d-flex flex-column gap-2 auction-details-right-content">
                        ...
                        <div class="d-flex align-items-center gap-10px">
                            <div class="minmax-xs-100px fs-14 title-semidark">{{ translate('Shipping Fee') }}</div>
                            <span>:</span>
                            <div class="info-option2">
                        ...
                        <div class="d-flex align-items-start gap-10px">
                            ...
                            <span>:</span>
                            <div class="info-option2">
                                <h4 class="fs-14 m-0 title-clr text-break fw-semibold line--limit-2" data-bs-toggle="tooltip" data-bs-title="{{ $auctionProduct?->return_policy }}">{{ $auctionProduct?->return_policy }}</h4>
                            </div>
                        </div>
                        @endif
                    </div>
    ...
    <div class="card border-0 shadow-sm p-xl-4 p-3">
        <ul class="nav nav-pills mb-20 d-flex align-items-center flex-wrap justify-content-center gap-1" id="claimed-pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link tab_link" id="claimed-desc-tab" data-bs-toggle="pill" data-bs-target="#claimed-bids-description" type="button" role="tab" aria-controls="claimed-bids-description" aria-selected="false">
                    {{ translate('Product Description') }}
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="claimed-history-tab" data-bs-toggle="pill" data-bs-target="#claimed-bids-history" type="button" role="tab" aria-controls="claimed-bids-history" aria-selected="true">
                    {{ translate('Bidding History') }}
                </button>
            </li>
            @if($hasVideo)
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="claimed-profile-video-tab" data-bs-toggle="pill"
                ...
                <div class="live-bidding-here">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-20">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label fs-13 text-secondary" for="myBidClaimedOnly">{{ translate('My Bids Only') }}</label>
                        </div>
                        @endif
                    </div>
                        ...
                        <div class="accordion" id="claimedAccordion">
                            <div class="accordion-item p-3 rounded light-box border-0">
                                <h2 class="accordion-header mb-12px p-0 bg-transparent outline-0 border-0">
                                    <button class="accordion-button gap-1 shadow-none p-0 bg-transparent outline-0 border-0" type="button" data-bs-toggle="collapse" data-bs-target="#claimedInsightCollapse" aria-expanded="true" aria-controls="claimedInsightCollapse">
