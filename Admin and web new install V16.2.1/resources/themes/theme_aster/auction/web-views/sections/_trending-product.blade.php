...
<div class="trending-auction-section p-20 bg-white card border-0 shadow-sm rounded overflow-hidden position-relative mb-20">
        ...
        <div class="d-flex justify-content-between flex-sm-nowrap flex-wrap align-items-center gap-2 mb-30">
            ...
            <div class="text-lg-center">
                <h2 class="m-0 text-capitalize fw-bold fs-5 d-flex align-items-center justify-content-lg-center gap-1">
                    <img width="34" height="34" src="{{ dynamicAsset(path: 'public/assets/front-end/auction/images/trending-fire.png') }}" alt="">
            ...
            <div class="text-end">
                <a class="d-flex align-items-center text-nowrap gap-1 text-capitalize text-decoration-none fs-14 view-all-text text-black"
