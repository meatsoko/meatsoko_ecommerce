...
<div class="mb-20 d-flex align-items-center gap-1 flex-wrap justify-content-between">
    <h5 class="fs-18 fw-semibold title-clr text-capitalize mb-0">
        {{ translate('Auction') }} {{ translate($selectedTabLabel) }} {{ $productLabel }}
    </h5>
...
<ul class="nav nav-rounded mb-3 text-nowrap flex-nowrap pb-2 d-flex overflow-auto d-flex align-items-center justify-content-start gap-xxl-20px gap-3" id="pills-tab" role="tablist">
                            ...
                            <div class="ending-soon-card bids-items-card bg-white bs-border rounded position-relative h-100">
                                <div class="d-flex gap-10px align-items-center h-100">
                                    <div class="rounded items-thumb overflow-hidden text-center position-relative flex-shrink-0">
                                        <a href="{{ route('auction.auction-update-product', ['id' => $auctionProduct->id]) }}" class="m-thumbnail d-block">
                                            <img
                                    ...
                                    <div class="w-100">
                                        ...
                                        @if($tab['key'] === 'rejected' && $auctionProduct->rejected_note)
                                            <div class="mt-2">
                                                <span class="fs-12 title-semidark d-block">{{ translate('Rejected Note') }}</span>
                                                <span class="fs-12 text-danger line--limit-2">{{ $auctionProduct->rejected_note }}</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
