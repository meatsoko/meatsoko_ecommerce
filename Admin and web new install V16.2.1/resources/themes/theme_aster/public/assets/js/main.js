        ...
        $swiper.each(function () {
            ...
            new Swiper($t[0], {
                ...
                direction: checkData($t.data("swiper-direction"), "horizontal"),
                                ...
                                // enable MutationObserver so swiper recalculates when DOM or styles change
                                observer: checkData($t.data("swiper-observer"), true),
                                observeParents: checkData($t.data("swiper-observe-parents"), true),
                                watchOverflow: true,
                ...
                on: {
                    init: function () {
                        ...
                        // Sometimes images or fonts load after init causing layout shift.
                        // Force a recalculation shortly after init to avoid "1 slide then expand" UX.
                        var swiper = this;
                        setTimeout(function () {
                            try {
                                swiper.update();
                                handleSwiperButtonVisibility(swiper);
                            } catch (e) {}
                        }, 60);
                    },
                    // when images are ready, ensure sizes are recalculated
