$(document).ready(function () {
    ...
    let placeholderImageUrl = window.placeholderImageUrl || $('#get-place-holder-image').data('src') || '';
    ...
    window.validateRequiredImages = function () {
        ...
        $(".multi_image_picker[data-required='true']").each(function () {
            ...
            if (!hasImage) {
                ...
                showErrorToast($picker.data("required-msg") || $("#text-validate-translate").data("required"));
