                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <div class="wallet-card pb-3 rounded-10 overlay ov-hidden"
                                        ...
                                        <div class="card-body d-flex flex-column gap-2 absolute-text-dark">
                                            ...
                                            <h2 class="fs-36 absolute-text-dark text-wrap text-break d-flex flex-wrap align-items-center">
                                            ...
                                            <p class="text-capitalize absolute-text-dark">{{ translate('total_balance') }}</p>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column flex-md-row gap-2 justify-content-between mb-4 align-items-md-center">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end z-99 shadow transaction-filter_dropdown">
