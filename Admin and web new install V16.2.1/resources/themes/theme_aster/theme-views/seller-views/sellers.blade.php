                    ...
                    <div class="auto-col xxl-items-6 justify-content-center gap-3 max-sm-grid-col-2">
                        @foreach ($vendorsList as $vendor)
                            ...
                            <a href="{{ route('vendor-shop',['slug' => $vendor['slug']]) }}"
                               class="store-item grid-center py-2 link-hover-base">
                                ...
                                <div class="d-flex flex-column align-items-center flex-wrap gap-2 mt-3 w-100 max-w-140px">
                                    <h6 class="text-truncate mx-auto text-center link-hover-base">
