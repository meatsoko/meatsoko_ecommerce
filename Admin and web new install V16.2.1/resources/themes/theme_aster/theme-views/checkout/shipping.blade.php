                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <button type="button"
                                                                                                    ...
                                                                                                    <img
                                                                                                        src="{{ theme_asset('assets/img/svg/location-edit-dynamic.svg') }}"
                                                                                                        alt="" class="svg">
                                                                                                </button>
                                                                                            </div>
                                                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-4">
                                                                ...
                                                                <select name="country" id="country" class="form-select select_picker select2">
                                                                    <option value="">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-4">
                                                                ...
                                                                <select name="billing_country" id="billing-country" class="form-select select_picker select2">
                                                                    <option value="">
                                                                        {{ translate('Select Your Country') }}
                                                                    </option>
                                                                    @forelse($countries as $country)
