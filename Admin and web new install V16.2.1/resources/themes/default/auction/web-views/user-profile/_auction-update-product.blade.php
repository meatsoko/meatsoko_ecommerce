                                                    ...
                                                    <div class="upload-file m-0 position-relative" id="existing_image_wrapper_{{ $index }}">
                                                        ...
                                                        <div class="overlay">
                                                            <div class="d-flex gap-1 justify-content-center align-items-center h-100">
                                                                ...
                                                                <button type="button"
                                                                    class="btn p-0 bg-danger h-20px min-w-20px w-20px position-absolute top-n7px end-n7px rounded-circle text-white d-center remove-existing-image"
