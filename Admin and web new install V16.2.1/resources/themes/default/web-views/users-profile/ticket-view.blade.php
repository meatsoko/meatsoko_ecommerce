                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        @if($ticket?->subject)
                                            <div class="d-flex align-items-start gap-2 gap-md-3 fs-14 mt-2">
                                                ...
                                                <span class="text-primary fw-semibold">{{ ucwords($ticket->subject) }}</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
