<div class="col-lg-3">
    ...
    <div class="__customer-sidebar user-profile-aside" id="shop-sidebar">
        ...
        <div>
            ...
            <div>
                <div class="widget-title">
                    <a class="{{Request::is('account-oder*') || Request::is('account-order-details*') ? 'active-menu' :''}}" href="{{route('account-oder') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <div>
                <div class="widget-title">
                    <a class="{{Request::is('user-restock-requests*') ? 'active-menu' :''}}" href="{{ route('user-restock-requests') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <div class="light-box rounded p-10px">
            ...
            <div class="d-flex flex-column gap-10px">
                ...
                @php($my_auctions_active = Route::is('auction.acution-create-product', 'auction.list', 'auction.auctions-request-list', 'auction.auction-update-product', 'auction.auction-recreate-product'))
                <div class="menu--caret-accordion">
                    <div class="card-header border-0 aside-items-profile aside-items-auction {{ $my_auctions_active ? 'active' : '' }} rounded menu--caret-box p-10px sub-header">
                        <div class="menu--caret w-100 cursor-pointer d-flex  align-items-center gap-1 justify-content-between {{ $my_auctions_active ? 'active' : '' }}">
                    ...
                    <div class="card-body p-0 pb-2 ps-2 {{ $my_auctions_active ? '' : 'd--none' }} bg-white">
                        ...
                        @endif
                        <a href="{{ route('auction.list') }}" class="py-2 fs-13 {{ Route::is('auction.list', 'auction.auction-update-product', 'auction.auction-recreate-product') ? 'text-primary' : 'title-clr' }} d-flex align-items-center gap-1 acount-items">
                            <i class="fi fi-sr-wifi-1 fs-14"></i> {{ translate('Auction List') }}
                        </a>
                        <a href="{{ route('auction.auctions-request-list') }}" class="py-2 fs-13 {{ Route::is('auction.auctions-request-list') ? 'text-primary' : 'title-clr' }} d-flex align-items-center gap-1 acount-items">
