...
class OrderSettingsController extends BaseController
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        $this->businessSettingRepo->updateOrInsert(type: 'service_fee_status', value: $request->get('service_fee_status', 0));
        $this->businessSettingRepo->updateOrInsert(type: 'service_fee_percentage', value: $request->get('service_fee_percentage', 0));
