...
const CACHE_ADDON_ADMIN_ROUTES = 'cache_addon_admin_routes';
const CACHE_PAYMENT_PUBLISH_STATUS = 'cache_payment_publish_status';
const CACHE_THEME_ROUTES = 'cache_theme_routes_';
const CACHE_FOOTER_SHOPS_LIST = 'cache_footer_shops_list';
const CACHE_ACTIVE_SOCIAL_MEDIA_LIST = 'cache_active_social_media_list';
const CACHE_HEADER_PAYMENT_GATEWAYS_LIST = 'cache_header_payment_gateways_list';
