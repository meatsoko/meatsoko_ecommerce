$(document).ready(function () {
    ...
    $(document).on('click', '.auction-shipping-policy-generate', function () {
        ...
        if (!title.length) {
            showErrorToast('Auction product name is required to generate shipping policy');
            return;
        }
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (!data || typeof data !== 'object') {
                    showErrorToast('Failed to generate shipping charge and return policy.');
                    return;
                }
            ...
            complete: function () {
                ...
                $(document).trigger('auction-ai-step-complete', [{ step: 'shipping-policy', success: stepSucceeded }]);
            }
        });
    });
});
