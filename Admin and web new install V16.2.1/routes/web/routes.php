    ...
    Route::group(['prefix' => 'payment'], function () {
        ...
        Route::group(['prefix' => 'sslcommerz', 'as' => 'sslcommerz.'], function () {
            ...
            Route::post('success', [SslCommerzPaymentController::class, 'success'])
                ->withoutMiddleware([VerifyCsrfToken::class])->middleware('throttle:60,1');
        ...
        //MPESA STK PUSH
        Route::group(['prefix' => 'mpesa-stk', 'as' => 'mpesa-stk.'], function () {
            Route::get('pay', [MpesaStkController::class, 'index'])->name('pay');
